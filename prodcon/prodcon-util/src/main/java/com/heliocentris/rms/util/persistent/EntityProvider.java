...
public interface EntityProvider<Entity extends Serializable, Key extends Serializable>
{
    ...
    * 
    */
   public enum OrderBy { Ascending, Descending, None }
    ...
    /**
     * 
     * @param entity the entity to be detach.
    ...
    /**
     * Returns the list <code>Entity</code> specified by the class limited by Integer.MAX_VALUE. 
     * 
     * @return the <code>List</code> of <code>Entity</code>.
     */
    ...
    /**
     * Returns the list <code>Entity</code> specified by the class limited by maxResults. 
     * 
     * @return the <code>List</code> of <code>Entity</code>.
     */
    ...
    /**
     * Returns the list <code>Entity</code> specified by the class, order by oid and limited by Integer.MAX_VALUE. 
     * 
     * @return the <code>List</code> of <code>Entity</code>.
     */
    ...
    /**
     * Returns the list <code>Entity</code> order by oid and limited by Integer.MAX_VALUE. 
     * 
     * @return the <code>List</code> of <code>Entity</code>.
     */
     ...
     * @param oid the key of the entity
