...
public class LoggerWrapper implements Logger {
	...
	public void trace(String format, Object arg) {
		...
		if (instanceofLAL) {
			...
			((LocationAwareLogger) logger).log(null, fqcn, LocationAwareLogger.TRACE_INT, tuple.getMessage(), null,
					null);
		} else {
	...
	public void trace(String format, Object arg1, Object arg2) {
		...
		if (instanceofLAL) {
			// String formattedMessage = MessageFormatter.format(format, arg1,
			// arg2);
	...
	public void trace(Marker marker, String format, Object arg) {
		...
		if (instanceofLAL) {
			FormattingTuple tuple = MessageFormatter.format(format, arg);
			((LocationAwareLogger) logger).log(marker, fqcn, LocationAwareLogger.TRACE_INT, tuple.getMessage(), null,
					null);
		} else {
	...
	public void debug(String format, Object arg) {
		...
		if (instanceofLAL) {
			FormattingTuple tuple = MessageFormatter.format(format, arg);
			((LocationAwareLogger) logger).log(null, fqcn, LocationAwareLogger.DEBUG_INT, tuple.getMessage(), null,
					null);
		} else {
	...
	public void debug(Marker marker, String format, Object arg) {
		...
		if (instanceofLAL) {
			FormattingTuple tuple = MessageFormatter.format(format, arg);
			((LocationAwareLogger) logger).log(marker, fqcn, LocationAwareLogger.DEBUG_INT, tuple.getMessage(), null,
					null);
		} else {
	...
	public void info(String format, Object arg) {
		...
		if (instanceofLAL) {
			...
			((LocationAwareLogger) logger)
					.log(null, fqcn, LocationAwareLogger.INFO_INT, tuple.getMessage(), null, null);
		} else {
	...
	public void info(Marker marker, String format, Object arg) {
		...
		if (instanceofLAL) {
			FormattingTuple tuple = MessageFormatter.format(format, arg);
			((LocationAwareLogger) logger).log(marker, fqcn, LocationAwareLogger.INFO_INT, tuple.getMessage(), null,
					null);
		} else {
	...
	public void warn(String format, Object arg) {
		...
		if (instanceofLAL) {
			FormattingTuple tuple = MessageFormatter.format(format, arg);
			((LocationAwareLogger) logger)
					.log(null, fqcn, LocationAwareLogger.WARN_INT, tuple.getMessage(), null, null);
		} else {
	...
	public void warn(Marker marker, String format, Object arg) {
		...
		if (instanceofLAL) {
			FormattingTuple tuple = MessageFormatter.format(format, arg);
			((LocationAwareLogger) logger).log(marker, fqcn, LocationAwareLogger.WARN_INT, tuple.getMessage(), null,
					null);
		} else {
	...
	public void error(String format, Object arg) {
		...
		if (instanceofLAL) {
			FormattingTuple tuple = MessageFormatter.format(format, arg);
			((LocationAwareLogger) logger).log(null, fqcn, LocationAwareLogger.ERROR_INT, tuple.getMessage(), null,
					null);
		} else {
	...
	public void error(Marker marker, String format, Object arg) {
		...
		if (instanceofLAL) {
			FormattingTuple tuple = MessageFormatter.format(format, arg);
			((LocationAwareLogger) logger).log(marker, fqcn, LocationAwareLogger.ERROR_INT, tuple.getMessage(), null,
					null);
		} else {
