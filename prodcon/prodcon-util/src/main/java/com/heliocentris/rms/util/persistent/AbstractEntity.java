...
/**
 * The <code>AbstractEntity</code> is the predefined  and premapped class for convenient use.
 * User may or may not inherits from the <code>AbstractEntity</code> to provide entity classes.
...
public abstract class AbstractEntity implements Serializable
{
   ...
   @Temporal(TemporalType.TIMESTAMP)
	...
	/**
	 * Returns the unique logical identifier of the entity.
	 * The uniqueness is not warranty over the class. This lie
	 * to the subclass.
	 * 
...
//            {
//                if (this.getOid().equals(that.getOid()) && this.getId().equals(that.getId()))
//                {
//                    return true;
//                }
//            }
